...
if (!customValidators) {
  ...
  customValidators.validateCnsaBaseline = function(viewValue, form, model) {
    ...
    if (model.employment === 3 && !model.unemployed) {
      return {
        custom: true,
        valid: false,
        error: {
    ...
    if (model.act_out_home === 1 && !model.describe_act_out) {
      return {
        custom: true,
        valid: false,
        error: {
    ...
    if (model.act_in_home === 1 && !model.describe_act_in) {
      return {
        custom: true,
        valid: false,
        error: {
    ...
    if ((model.smoking_status === 1 || model.smoking_status === 2) && !model.smoking_cessation) {
      return {
        custom: true,
        valid: false,
        error: {
...
if (!customValidators) {
  ...
  customValidators.validateCnsaCervicalComplications = function(viewValue, form, model) {
    var fieldId = form.fieldId;
    var element_ids = [];
    var noMsg = {};
    var id;
    ...
    var reasons = [
      ...
      "toggle_complication_reason_cfs_leak",
